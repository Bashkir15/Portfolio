...
/***/ function(module, exports, __webpack_require__) {
	...
	function toggleSideNav(nav) {
		nav.classList.add("sidenav-container--animatable");

		if (!nav.classList.contains("sidenav-container--visible")) {
			nav.classList.add("sidenav-container--visible");
		} else {
			nav.classList.remove("sidenav-container--visible");
		}
	}

	function onTransitionEnd(nav) {
		nav.classList.remove("sidenav-container--animatable");
	}
